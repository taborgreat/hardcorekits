 ...
 *
 * <p>Behaviour lives in {@link gg.hungergames.listener.HulkListener}.
 */
public final class HulkKit implements Kit {
    ...
    public String description() {
        return "Empty-handed: right-click a player to pick them up, left-click to throw them. "
                + "They can sneak to break free.";
    }
