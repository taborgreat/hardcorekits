 ...
 * hook in {@code HungerGames} clears it between matches like any per-match state.
 */
public final class CooldownBar {
    ...
    public static void show(HungerGames plugin, GameManager game, Player player, double seconds) {
