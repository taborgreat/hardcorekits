...
public final class EndgameManager {
    ...
    EndgameManager(HungerGames plugin, GameManager game, GameConfig config) {
        this.plugin = plugin;
        this.game = game;
        this.config = config;
    }
    ...
    private void finish() {
        ...
        // Stand-in tributes from /hgfake were never teleported anywhere and would otherwise hold
